...
public final class cargarPedidosClienteJSON_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String cadena = "[{nombre:'" + nombreProducto + "',cantidad:'" + cantidad + "', precio:'" + precio + "', deescuento'" + descuento + "', total:'" + total + "'}]";
