...
public class ServletNuevoPedido extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Servlet ServletNuevoPedido</title>");
        out.println("</head>");
        out.println("<body>");
        ...
        boolean tlfcorrecto = Bd.consultaTlf(telefono, usr);
        if (tlfcorrecto) {
            if (menus.equals("0") && bebidas.equals("0") && complementos.equals("0") && ensaladas.equals("0") && sandwiches.equals("0")) {
            ...
            rd = contexto.getRequestDispatcher("/errorTelefono.jsp");
            rd.forward(request, response);
        }
