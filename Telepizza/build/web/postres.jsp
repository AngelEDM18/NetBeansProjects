...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
            ...
            ArrayList<Postre> listaPostres = Bd.consultaPostres();
        %>
    </head>
    <body>
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="postre">
                            ...
                            <option value="<%=listaPostres.get(i).getDescripcion()%>"><%=listaPostres.get(i).getDescripcion()%></option>
                            <%}
                            %>
                        </select>
                        <select name="cantPostre">
                                                                            ...
                                                                            <input type="hidden" name="cantEnsalada" value="<%=cantEnsalada%>">
                                                                                <input type="hidden" name="bebida" value="<%=bebida%>">
                                                                                    <input type="hidden" name="cantBebida" value="<%=cantBebida%>">
                                                                                        <br/><br/><input type="submit" value="Confirmar pedido"/>
                                                                                        </td>
                                                                                        <td colspan="2" align="right">Bienvenido</td>
                                                                                        <td width="7%" rowspan="5" bgcolor="#FFFFFF">&nbsp;</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td width="25%" align="center"><img src="images/images_2016/postres.png" width="549" height="312"/></td>
                                                                                        </tr>
                                                                                        <tr>
