...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
            ...
            ArrayList<Pasta> listaPastas = Bd.consultaPastas();
        %>
    </head>
    <body>
        <form action="ensalada.jsp" method="post">
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="pasta">
                            ...
                            <option value="<%=listaPastas.get(i).getDescripcion()%>"><%=listaPastas.get(i).getDescripcion()%></option>
                            <%}
                            %>
                        </select>
                        <select name="cantPasta">
                                                    ...
                                                    <input type="hidden" name="cantEntrante" value="<%=cantEntrante%>">
                                                        <input type="hidden" name="hamburguesa" value="<%=hamburguesa%>">
                                                            <input type="hidden" name="cantHamburguesa" value="<%=cantHamburguesa%>">
                                                                <br/><br/><input type="submit" value="Pasar a ensaladas"/>
                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td width="25%" align="center"><img src="images/images_2016/pasta.png" width="549" height="312"/></td>
                                                                </tr>
                                                                <tr>
