...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
            ...
            ArrayList<Entrante> listaEntrantes = Bd.consultaEntrantes();
        %>
    </head>
    <body>
        <form action="hamburguesa.jsp" method="post">
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="entrante">
                            ...
                            <%
                                for (int i = 0; i < listaEntrantes.size(); i++) {%>
                            <option value="<%=listaEntrantes.get(i).getDescripcion()%>"><%=listaEntrantes.get(i).getDescripcion()%></option>
                            <%}
                            %>
                        </select>
                        <select name="cantEntrante">
                                    ...
                                    <input type="hidden" name="cantMenu" value="<%=cantMenu%>">
                                        <input type="hidden" name="pizza" value="<%=pizza%>">
                                            <input type="hidden" name="cantPizza" value="<%=cantPizza%>">
                                                <br/><br/><input type="submit" value="Pasar a hamburguesas"/>
                                                </td>
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td width="25%" align="center"><img src="images/images_2016/entrantes.png" width="549" height="312"/></td>
                                                </tr>
                                                <tr>
