...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="entrantes.jsp" method="post">
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="pizza">
                            ...
                            <option value="<%=listaPizzas.get(i).getNompizzas()%>"><%=listaPizzas.get(i).getNompizzas()%></option>
                            <%}
                            %>
                        </select>
                        <select name="cantPizza">
                            ...
                            <input type="hidden" name="cantOferta" value="<%=cantOferta%>">
                                <input type="hidden" name="menu" value="<%=menu%>">
                                    <input type="hidden" name="cantMenu" value="<%=cantMenu%>">
                                        <br/><br/><input type="submit" value="Pasar a entrantes"/>
                                        </td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td width="25%" align="center"><img src="images/images_2016/pizzas.jpg" width="549" height="312"/></td>
                                        </tr>
                                        <tr>
