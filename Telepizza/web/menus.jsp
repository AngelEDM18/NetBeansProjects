...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
            ...
            ArrayList<Menu> listaMenus = Bd.consultaMenus();
        %>
    </head>
    <body>
        <form action="pizzas.jsp" method="post">
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="menu">
                            ...
                            <option value="<%=listaMenus.get(i).getDescripcion()%>"><%=listaMenus.get(i).getDescripcion()%></option>
                            <%}
                            %>
                        </select>
                        <input type="hidden" name="oferta" value="<%=oferta%>">
                            <input type="hidden" name="cantOferta" value="<%=cantOferta%>">
                                <select name="cantMenu">
                                ...
                                <br/><br/><input type="submit" value="Pasar a pizzas"/>
                                </td>
