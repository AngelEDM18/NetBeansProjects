...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <%
        ...
        ArrayList<Ensalada> listaEnsaladas = Bd.consultaEnsaladas();
    %>
    <body>
        <form action="bebidas.jsp" method="post">
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="ensalada">
                            ...
                            <option value="<%=listaEnsaladas.get(i).getDescripcion()%>"><%=listaEnsaladas.get(i).getDescripcion()%></option>
                            <%}
                            %>
                        </select>
                        <select name="cantEnsalada">
                                                            ...
                                                            <input type="hidden" name="cantHamburguesa" value="<%=cantHamburguesa%>">
                                                                <input type="hidden" name="pasta" value="<%=pasta%>">
                                                                    <input type="hidden" name="cantPasta" value="<%=cantPasta%>">
                                                                        <br/><br/><input type="submit" value="Pasar a bebidas"/>
                                                                        </td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="25%" align="center"><img src="images/images_2016/ensaladas.png" width="549" height="312"/></td>
                                                                        </tr>
                                                                        <tr>
