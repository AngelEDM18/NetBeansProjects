...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%
            ...
            ArrayList<Hamburguesa> listaHamburguesas = Bd.consultaHamburguesas();
        %>
    </head>
    <body>
        <form action="pasta.jsp" method="post">
                ...
                <tr align="center">
                    ...
                    <td width="46%" align="center" rowspan="5" class="ff">
                        ...
                        <select name="hamburguesa">
                            ...
                            <option value="<%=listaHamburguesas.get(i).getDescripcion()%>"><%=listaHamburguesas.get(i).getDescripcion()%></option>
                            <%}
                            %>
                        </select>
                        <select name="cantHamburguesa">
                                            ...
                                            <input type="hidden" name="cantPizza" value="<%=cantPizza%>">
                                                <input type="hidden" name="entrante" value="<%=entrante%>">
                                                    <input type="hidden" name="cantEntrante" value="<%=cantEntrante%>">
                                                        <br/><br/><input type="submit" value="Pasar a pastas"/>
                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td width="25%" align="center"><img src="images/images_2016/hamburguesa.png" width="549" height="312"/></td>
                                                        </tr>
                                                        <tr>
