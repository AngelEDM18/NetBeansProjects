...
<html>
    ...
    <body>
        ...
        <br/>
        <center>
            <form action="/VentasComerciales/Modificar">
                <table border="1">
                    <tr>
                        <td>Comercial</td>
                        <td>Producto</td>
                    ...
                    <%                
                        for (int x = 0; x < ventas.size(); x++) {
                            ...
                            out.println("<td><input type='number' name='cantidadMod"+x+"' value='"+ventas.get(x).getCantidadProducto()+"'></td>");
                            ...
                            out.println("<input type='hidden' name='max' value='"+ventas.size()+"'>");
                            out.println("<input type='hidden' name='cod' value='"+codigo+"'>");
                            out.println("</tr>");
                        }
                    %>
                </table>
